...
(function(root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.start_date_name === 'string')
                this.start_date_name = options.start_date_name;

            if (typeof options.end_date_name === 'string')
                this.end_date_name = options.end_date_name;
        ...
        updateInputText: function() {
            ...
            $('[name='+this.start_date_name+']').val(this.startDate.format(this.format));
            $('[name='+this.end_date_name+']').val(this.endDate.format(this.format));
        },
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><i class="glyph-icon icon-arrow-left icon-arrow-left glyphicon glyphicon-arrow-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><i class="glyph-icon icon-arrow-right icon-arrow-right glyphicon glyphicon-arrow-right"></i></th>';
            } else {
                html += '<th></th>';
            }
